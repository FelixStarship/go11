...
在代码 定义了一个锁抽象，interface提供了一个通用接口，用于锁定leader选举中使用的资源。
...
## 运行结果
```sh
ubuntu@VM-4-5-ubuntu:~$ ./main -kubeconfig=/home/ubuntu/.kube/config  -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=1
I0115 16:16:16.910134 3800436 leaderelection.go:248] attempting to acquire leader lease default/example...
I0115 16:16:17.022983 3800436 leaderelection.go:258] successfully acquired lease default/example
I0115 16:16:17.023121 3800436 main.go:84] Controller loop...
```

```sh
ubuntu@VM-4-5-ubuntu:~$ ./main -kubeconfig=/home/ubuntu/.kube/config  -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=2
I0115 16:16:35.214232 3800602 leaderelection.go:248] attempting to acquire leader lease default/example...
I0115 16:16:35.219045 3800602 main.go:148] new leader elected: 1
```


```sh
ubuntu@VM-4-5-ubuntu:~$ ./main -kubeconfig=/home/ubuntu/.kube/config  -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=3
I0115 16:16:44.195150 3800716 leaderelection.go:248] attempting to acquire leader lease default/example...
I0115 16:16:44.200718 3800716 main.go:148] new leader elected: 1
```
